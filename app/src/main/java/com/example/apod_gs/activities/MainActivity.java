...
import com.example.apod_gs.fragment.DatePickerFragment;
import com.example.apod_gs.classes.PrefConfig;
...
public class MainActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private static final String mUrlRequestDefaultKey = "https://api.nasa.gov/planetary/apod?api_key=ZTkGpjUdhd6CRJZa9MHkI1aimjFhcdrp9FAxGa4M\n";
    ...
    public static String mUrlRequestForJsonLastActive = null;

    protected void setmFavoriteList(String jsonLink) {
        mFavoriteList.add(jsonLink);
    }

    public static Set<String> mFavoriteList = new HashSet<>();
